<template>
    <div>
        ...
        >
            <template #activator>
                <v-list-item-avatar
                    ...
                    size="40"
                >
                    <v-img :src="layerPreview" :lazy-src="layerPreview" />
                </v-list-item-avatar>
                <v-list-item-content>
                ...
                <v-list-item-action @click.stop="" class="pl-2">
                    <v-icon
            ...
            <v-container class="py-0">
                <SupportLayerFilters v-if="showFilters" :layer="layer" />
                <v-row
                    v-if="
                        layer.layer_type === 'wms' &&
                        layer.visible &&
        ...
        <v-container class="py-0">
            <SupportLayerMetadata v-if="showMetadata" :layerId="layerId" />
        </v-container>
        <v-divider
            v-if="
                (layer.layer_type === 'wms' &&
