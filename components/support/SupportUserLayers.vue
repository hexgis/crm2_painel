<template>
    <v-list-group v-model="isOpen" append-icon="">
        <template #activator>
            <v-list-item-content>
        ...
        <v-container v-if="layer.visible " class="py-0">
            <v-row class="black--text text--lighten-2" align="center" v-if="!isPointType" >
        ...
        <v-dialog v-model="rename" max-width="800">
            <v-card>
                ...
                <v-card-actions class="justify-end">
                    <v-btn color="accent" @click="handleSave">
                        {{ $t('button-label') }}
                    </v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
        <v-dialog v-model="remove" width="300">
            <v-card>
                ...
                <v-card-actions class="justify-end">
                    <v-btn color="" text @click="remove = false">
                        {{ $t('cancel-button') }}
                    </v-btn>
                    <v-btn color="accent" text @click="removeLayer">
                        {{ $t('confirm-button') }}
                    </v-btn>
                </v-card-actions>
            </v-card>
