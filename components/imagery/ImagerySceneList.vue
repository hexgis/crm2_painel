<template>
    <div>
        <v-row v-if="isHighResSatellite" class="mx-0 py-3">
            ...
            <template v-for="(scene, i) in scenes">
                ...
                >
                    ...
                    <template v-if="!isHighResSatellite">
                        <v-divider />
                        <ImagerySceneImages :scene="scene" :index="i" />
                    </template>
                </v-list-group>
        ...
        <v-row v-if="satellite && satellite.agency !== 'HEAD'" class="mx-0">
            <v-col>
                <v-pagination
                    v-model="page"
                    color="primary"
...
export default {
    ...
    methods: {
        ...
        sortScenes() {
            const sortKey =
                (this.sortDirection ? this.sortDirection : '') + this.sortKey
