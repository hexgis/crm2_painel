    ...
    <div class="button-print-map d-flex mt-3">
        <v-tooltip right>
            <template #activator="{ on }">
                <v-btn fab ripple height="36" width="36" v-on="on">
        ...
        async generatePdf() {
            ...
            try {
                ...
                await domtoimage.toJpeg(node, options).then((image) => {
                    ...
                    let aspectRatio = node.offsetWidth / node.offsetHeight
                    let imageWidth =
                        aspectRatio >= 1 ? width : height * aspectRatio
                    let imageHeight =
                        aspectRatio >= 1 ? width / aspectRatio : height
